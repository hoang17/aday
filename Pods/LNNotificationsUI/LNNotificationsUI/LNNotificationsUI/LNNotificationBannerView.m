...
- (instancetype)initWithFrame:(CGRect)frame style:(LNNotificationBannerStyle)style
{
	...
	if(self)
	{
		...
		[_appIcon addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"H:[_appIcon(40)]" options:0 metrics:nil views:NSDictionaryOfVariableBindings(_appIcon)]];
		[_appIcon addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"V:[_appIcon(40)]" options:0 metrics:nil views:NSDictionaryOfVariableBindings(_appIcon)]];

...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "$BUILT_PRODUCTS_DIR/LNNotificationsUI/LNNotificationsUI.framework"
  install_framework "$BUILT_PRODUCTS_DIR/PGMCameraKit/PGMCameraKit.framework"
  install_framework "$BUILT_PRODUCTS_DIR/PGMTimer/PGMTimer.framework"
